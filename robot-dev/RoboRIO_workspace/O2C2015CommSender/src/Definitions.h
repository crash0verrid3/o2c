...
enum DisplayType_t {HiddenFloat=-8, HiddenLong=-7, HiddenInt=-6, HiddenShort=-5,
					HiddenChar=-4, HiddenString=-3, HiddenDouble=-2, HiddenBoolean=-1, Hidden=0,
					Boolean=1, Double=2, String=3, Char=4, Short=5, Int=6, Long=7, Float=8};
union DashType_t
	{
	double			doubleValue;
	bool			boolValue;
...
struct StatusValue
	{
	DashType_t		Value;
	int8_t			DecimalShift;	/*	SmartDashboard does not hold enough decimal places for very small numbers
										so SmartDashboard PutNumber will multiply Value times 10^DecimalShift
										and SmartDashboard GetNumber will divide Value by 10^DecimalShift	*/
	DisplayType_t	DisplayType;
	char			Title[16];
	} *pMyRobotState2;

enum StatusNames {	Comms_Init=0
					,Robot_Init=1
					,Robot_Heading=2
					,Robot_Direction=3
					,Robot_Speed=4
					...
					,Battery_Voltage=8
					,Drivetrain_Init=9
					,Drivetrain_FL_Motor_Power=10
					,Drivetrain_FR_Motor_Power=11
					,Drivetrain_BL_Motor_Power=12
					,Drivetrain_BR_Motor_Power=13
					,Drivetrain_Speed_Control=14
					,Drivetrain_Spin_Control=15
					,Drivetrain_Heading=16
					,Drivetrain_Directional_Orientation=17
					,Navigation_Init=18
					,Navigation_Robot_Lost=19
					,Navigation_GyroTilt=20
					,ToteLift_Init=21
					,ToteLift_Position=22
					,ToteLift_Target=23
					,ToteLift_Speed=24
					,ToteLift_Direction=25
					,ToteLift_ToteCount=26
					,ToteLift_JoyMode=27
					,Pincer_Init=28
					,Pincer_Arm1_Position=29
					,Pincer_Arm1_Speed=30
					,Pincer_Arm2_Position=31
					,Pincer_Arm2_Speed=32
					,Pincer_Grip_Position=33
					,Pincer_Grip_Speed=34
					,Pincer_Grip_Height=35
					,Pincer_Grip_Reach=36
					,ToteWheels_Init=37
					,ToteWheelArm_Left_Position=38
					,ToteWheelArm_Right_Position=39
					,ToteWheels_Left_Speed=40
					,ToteWheels_Right_Speed=41
					,Autonomous_Init=42
					,Autonomous_Step=43
					,Autonomous_Scenario=44
				    ,Totalruns=45
				    ,Autoruns=46
					,Teleruns=47
					,Testruns=48
...
static StatusValue TestStateBuffer[Buffer_Length] = {
		{0,0,Short,"Comms Init"}
 		,{0,-2,Float,"Heading"}
		,{0,-2,Float,"Direction"}
		,{0,-2,Float,"Speed"}
		,{0,0,Int,"Xcoord"}
		,{0,0,Int,"Ycoord"}
		,{0,-2,Float,"Spin Rate"}
		,{0,0,Short,"Robot Init"}
		,{0,-1,Float,"Battery"}
		,{0,0,Short,"DrvTrn Init"}
		,{0,-3,Float,"FL Power"}
		,{0,-3,Float,"FR Power"}
		,{0,-3,Float,"BL Power"}
		,{0,-3,Float,"BR Power"}
		,{0,-2,Float,"Speed Factor"}
		,{0,0,Boolean,"Spin Control"}
		,{0,-2,HiddenFloat,"DT Heading"}
		,{0,0,HiddenFloat,"DT Orient"}
		,{0,0,Short,"Nav Init"}
		,{0,0,Boolean,"Nav Lost"}
		,{0,0,Boolean,"Nav Tilt"}
		,{0,0,Short,"Lift Init"}
		,{0,0,Float,"Lift Height"}
		,{0,0,HiddenFloat,"Lift Target"}
		,{0,-2,HiddenFloat,"Lift Speed"}
		,{0,0,HiddenInt,"Lift Dir"}
		,{0,0,HiddenInt,"Lift Count"}
		,{0,0,Int,"Lift Mode"}
		,{0,0,Short,"Pincer Init"}
		,{0,-1,HiddenFloat,"Arm1 Posn"}
		,{0,-3,HiddenFloat,"Arm1 Speed"}
		,{0,-1,HiddenFloat,"Arm2 Posn"}
		,{0,-3,HiddenFloat,"Arm2 Speed"}
		,{0,-1,HiddenFloat,"Grip Posn"}
		,{0,-3,HiddenFloat,"Grip Speed"}
		,{0,0,HiddenFloat,"Grip Height"}
		,{0,0,HiddenFloat,"Grip Reach"}
		,{0,0,Short,"Wheels Init"}
		,{0,0,Int,"Wheel LPosn"}
		,{0,0,Int,"Wheel RPosn"}
		,{0,-3,Float,"Wheel LSpeed"}
		,{0,-3,Float,"Wheel RSpeed"}
		,{0,0,Short,"Auto Init"}
		,{0,0,Int,"Auto Step"}
		,{0,0,Int,"Auto Progrm"}
		,{0,0,Int,"Total Runs"}
		...
		,{0,0,Int,"TeleOp Runs"}
		,{0,0,Int,"Test Runs"}
		,{0,0,Int,"Disabled Runs"}
		,{0,0,Int,"Enabled Runs"}
		};
